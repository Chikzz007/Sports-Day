...
app.post('/register', async (req, res) => {
  try {
    ...
    const requiredFields = { name, email, mobile, registerNumber, department, role, eventName, timeSlot };
    ...
    const allowedEvents = ['Phantom League', 'VolleyX', 'PowerPlay Premier'];
    const allowedSlots  = ['10 AM', '2 PM'];
