...
const registrationSchema = new mongoose.Schema(
  {
    ...
    // Role in the event (Player / Coach / Referee / Spectator)
    role: {
      type:     String,
      required: [true, 'Role is required'],
      enum:     ['Player', 'Coach', 'Referee', 'Spectator'],
    },

    // Which event they registered for (Phantom League / VolleyX / PowerPlay Premier)
    eventName: {
      type:     String,
      required: [true, 'Event name is required'],
      enum:     ['Phantom League', 'VolleyX', 'PowerPlay Premier'], // only these values allowed
    },
